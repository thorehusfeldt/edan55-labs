...
\node (a) at (0,0){
      ...
      main node/.style={circle,draw,fill=black!10}]
...
\node (b) at (2,0) {
    \begin{tikzpicture}
      ...
      \node[main node] (7) [above right of=6] {};
      \node[main node] (8) [above of=7] {};
      \node[removed node,fill = blue!20] (9) [above right of=2] {$v$};
...
\node (base) at (0,0) {
    ...
    \begin{tikzpicture}
      ...
      main node/.style={circle,draw,fill=black!10},
      removed node/.style={dotted,circle,draw}]

      \node[removed node,fill = blue!20] (1) {$u$};
