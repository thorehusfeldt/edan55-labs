...
vertex_style/.style={circle,shading=ball,ball color=red,draw=red!80!white},
edge_style/.style={ultra thick, black}]
%\useasboundingbox (-5.05,-4.4) rectangle (5.1,5.25);
\begin{scope}[rotate=90]
\foreach \x/\y in {0/1,72/2,144/3,216/4,288/5}{
 \node[vertex_style] (\y) at (canvas polar cs: radius=1.8cm,angle=\x){};
}
\foreach \x/\y in {0/6,72/7,144/8,216/9,288/10}{
 \node[vertex_style] (\y) at (canvas polar cs: radius=3.0cm,angle=\x){};
}
\end{scope}
...
\draw[ultra thick, red] (1) to [out=270,in=45] (3);
\draw[ultra thick, black] (1) -- (3);
\draw[ultra thick, blue] (1) to [out=225,in=90] (3);

\draw[ultra thick, yellow] (1) to [out=270,in=135] (4);
\draw[ultra thick, green] (1) -- (4);
\draw[ultra thick, blue] (1) to [out=315,in=90] (4);

\draw[ultra thick, black] (2) to [out=290,in=160] (4);
\draw[ultra thick, green] (2) -- (4);
\draw[ultra thick, red] (2) to [out=350,in=100] (4);

\draw[ultra thick, yellow] (3) -- (5);
\draw[ultra thick, black] (5) -- (2);

\draw[ultra thick, red] (6) to [out=240,in=25] (7);
\draw[ultra thick, black] (6) -- (7);
\draw[ultra thick, blue] (6) to [out=190,in=60] (7);

\draw[ultra thick, green] (7) -- (8);
\draw[ultra thick, red] (8) -- (9);
\draw[ultra thick, blue] (9) -- (10);
\draw[ultra thick, black] (10) -- (6);


\draw[ultra thick, green] (1) -- (6);
\draw[ultra thick, black] (2) -- (7);
\draw[ultra thick, yellow] (3) -- (8);
\draw[ultra thick, red] (4) -- (9);

\draw[ultra thick, blue] (5) to [out=45,in=180] (10);
\draw[ultra thick, green] (5) to [out=10,in=210] (10);
